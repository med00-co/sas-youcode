...
switch (afficheItsChoose){
    ...
    //     let politiqueExiste = {}
    // candidats.forEach(condi =>{
        
    //   if (politiqueExiste.hasOwnProperty(condi.partiPolitique) ){
    //     politiqueExiste[condi.partiPolitique] = 2
    //   }else{
    //     politiqueExiste[condi.partiPolitique]= 1
    //   }
    //     console.log("Les parties politiques existes : ")
    //     for(index in politiqueExiste){
    //        console.log("   - ",index)
    //     }
        //----------------------------------------------------------------- 
    ...
    for(let i =1 ; i<= 1 ; i++){
        ...
        //  vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
         ...
         while(true){
           ...
           if(candidatPourAjouté.prenom !== ""){
                 break
           }else{
               console.log("Error ; il est interdit de laisser le prénom vide. ")
           }
         }
...
let choose = parseInt(prompt("Votre séléction : "))
 switch(choose){ 
    ...
    case 8:
        ...
        break;
    case 0:
        console.log("Merci d'utiliser notre programme  ^_^ ")
        break;
    default:
